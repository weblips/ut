<?php
namespace Weblips\AdminAutoLogin\Plugin;
...
class Authentication
{
    ...
    /**
     * @var \Weblips\AdminAutoLogin\Model\Config\Source\AdminUser
     */
    ...
    public function __construct(
        ...
        \Weblips\AdminAutoLogin\Model\Config\Source\AdminUser $adminUserSource
    ) {
        $this->auth = $auth;
